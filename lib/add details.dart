              ...
              child: Icon(Icons.keyboard_arrow_left_rounded,color: Colors.purple,)),
                ...
                Padding(
                  ...
                  child: Container(
                    height: 100,
                    width: 300,
                    child: Image.asset('assets/Frame 89.png',),
                  ),
                ),
                Text('Arjun Das',style: TextStyle(
                  fontWeight: FontWeight.normal,
                  fontSize: 30,
                ),),
                Text('Product Designer',style: TextStyle(color: Colors.grey),),
                Text('arjundas123@gmail.com ',style: TextStyle(color: Colors.grey),),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: ElevatedButton(onPressed: (){}, child: Text('View Resume'),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: ElevatedButton(onPressed: (){}, child: Text('ShortList'),
                          style: ElevatedButton.styleFrom(
                              backgroundColor:Colors.purple,
                              foregroundColor: Colors.white,
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)))),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: ElevatedButton(onPressed: (){}, child: Text('Browse file'),
                      style: ElevatedButton.styleFrom(
